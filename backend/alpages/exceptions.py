    ...
    if response is None and isinstance(exc, ProtectedError):
        ...
        for obj in exc.protected_objects:
            ...
            name = (
                ...
                if stats.get(model_meta.verbose_name)
                else model_meta.verbose_name
            )
        ...
        for label, count in stats.items():
            ...
            name = (
                model_meta.verbose_name
                if count <= 1
                else model_meta.verbose_name_plural
            )
        ...
        return Response(
            {
                ...
                "meta": {"dependencies": stats, "target_model": parent_name},
            },
