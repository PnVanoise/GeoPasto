LST_STATUT = [("existant", "existant"), ("besoin", "besoin")]
...
LST_ETAT_BATIMENT = [("bon", "bon"), ("moyen", "moyen"), ("delabre", "délabré")]

LST_OUI_NON = [("oui", "oui"), ("non", "non")]

LST_OUI_NON_INC = [("oui", "oui"), ("non", "non"), ("inconnu", "inconnu")]
