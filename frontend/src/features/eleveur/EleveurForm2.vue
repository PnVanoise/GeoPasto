...
.eleveur-form :deep(.v-input--density-compact .v-field__input) {
  min-height: 38px;
  padding-top: 6px;
  padding-bottom: 6px;
}
.eleveur-form :deep(.v-label.v-field-label) {
  font-size: 0.82rem;
}
.eleveur-form :deep(.v-input) {
  font-size: 0.88rem;
}
.eleveur-form :deep(.v-field__input),
.eleveur-form :deep(.v-select__selection-text) {
  font-size: 0.88rem;
}
.form-ligne {
  padding: 4px;
