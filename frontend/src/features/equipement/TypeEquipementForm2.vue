...
.type-equipement-form :deep(.v-input--density-compact .v-field__input) { min-height: 38px; padding-top: 6px; padding-bottom: 6px; }
.type-equipement-form :deep(.v-label.v-field-label) { font-size: 0.82rem; }
.type-equipement-form :deep(.v-input) { font-size: 0.88rem; }
.type-equipement-form :deep(.v-field__input),
.type-equipement-form :deep(.v-select__selection-text) { font-size: 0.88rem; }
