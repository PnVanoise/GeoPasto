  ...
  <div>
    ...
    <div v-if="selectedFeature">
      <div v-if="!isEditing">
        ...
        <p>
          <strong>Code quartier (court):</strong>
          {{ selectedFeature.properties.quartier_code_court }}
        </p>
            ...
            <div class="row">
              ...
              <div class="col-75">
                <input
                  id="surface_quartier"
                  type="text"
                  placeholder="Surface du quartier"
            ...
            <div class="row">
              ...
              <div class="col-75">
                <input
                  ...
                  type="text"
                  placeholder="Code quartier (court)"
